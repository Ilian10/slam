...
mesh_file = "/envau/work/meca/users/salmi.i/Surf_Hemi_full/sub-CC00861XX12_ses-20830_desc-restore_T2w_nnUNet_split.nii.gz/sub-CC00861XX12_ses-20830_desc-restore_T2w_nnUNet_split_extract_surf_right_hemi_n20.gii"
...
mesh_data['title'] = 'example_mesh_n20.gii'
intensity_data=None
display_settings= {}
Fig = splt.mesh_projection(
    mesh_data=mesh_data,#,
    ...
    display_settings=display_settings)
# Fig.show()
Fig.write_html("example_curvature_n20.html")
